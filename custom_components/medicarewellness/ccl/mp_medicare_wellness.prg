/**************************************************************************
 Program Title:   mp_medicare_wellness
 
 Object name:     mp_medicare_wellness
 Source file:     mp_medicare_wellness.prg
...
drop program mp_medicare_wellness:dba go
create program mp_medicare_wellness:dba
...
set html_ret = build2(^<div class="mmw_parent"></div>^)
...
set html_ret = build2(html_ret, ^<img src='../custom_mpage_content/mpage_reference_files/common/img/blank.png' width='0px' height='0px' ^,
                                     ...
                                     ^onLoad='var compJS = document.createElement("script");^,
	                                         ...
	                                         ^compJS.setAttribute("src",^,
                                                      ^"../custom_mpage_content/mpage_reference_files/medicarewellness/js/mp_medicare_wellness.js");^,
	                                         ...
	                                         ^compCSS.setAttribute("href",^,
                                                      ^"../custom_mpage_content/mpage_reference_files/medicarewellness/css/mp_medicare_wellness.css");^,
