/**************************************************************************
 Program Title:   Post Op Custom Component
 
 Object name:     mp_cust_post_op
 Source file:     mp_cust_post_op.prg
...
drop program mp_cust_post_op:dba go
create program mp_cust_post_op:dba
...
set html_ret = build2(^<div class="mcpo_parent"></div>^)
...
set html_ret = build2(html_ret, ^<img src='../custom_mpage_content/mpage_reference_files/common/img/blank.png' width='0px' height='0px' ^,
                                     ...
                                     ^onLoad='var compJS = document.createElement("script");^,
	                                         ...
	                                         ^compJS.setAttribute("src",^,
                                                      ^"../custom_mpage_content/mpage_reference_files/PostOp/js/mp_cust_post_op.js");^,
	                                         ...
	                                         ^compCSS.setAttribute("href",^,
                                                      ^"../custom_mpage_content/mpage_reference_files/PostOp/css/mp_cust_post_op.css");^,
