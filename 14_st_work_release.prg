/*************************************************************************
 Program Title:   Work Release Form ST
 
 Object name:     14_st_work_release
 Source file:     14_st_work_release.prg
 
 Purpose:         Simple form letter for a work release including 
                  encounter location.
...
*************END OF ALL MODCONTROL BLOCKS* *******************************/
  drop program 14_st_work_release:dba go
create program 14_st_work_release:dba
...
set tmp_str = notrim(build2(tmp_str, 'Please excuse from work for the following date(s): _', reol))
