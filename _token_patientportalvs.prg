...
**********************************************************************************************************************************
 ...
 002  06/20/19    Jeremy Daniel         MCGA              Added peds indicator code and change verbiage for each scenario
 003  09/19/2019  Jeremy Daniel         MCGA              Added MU section
 004  02/02/2021  Simeon Akinsulie      MCGA228288/TASK4195245 (Modify text)
...
drop program _token_patientportalVS go
create program _token_patientportalVS
 /****************************************************************************************************
...
;                                   "</tr>",
;                               "</table>",
    set csText = concat(csText,"<p style='font-size:16pt;text-align:center'>Manage your health care anytime, anywhere with the",
                               " MedStar Health Patient Portal</p>",
...
;                               "</table>",
    ...
    "If you have questions or need assistance creating your account, please contact myMedStar support toll ",
