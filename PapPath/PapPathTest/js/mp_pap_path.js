...
$('body').on('click', '.pocButton', function() {
    ...
    RPOCClick = function (e) {
        ...
        if(comment.length > 0 || fuDate !== 0){
            ...
            console.log('cust_mp_hr_obgyn_comment_test ' + opts);
            mPageCCLCall('cust_mp_hr_obgyn_comment_test', parseReply)(opts);
        }
        toggleModal('#HRPOCModal');
    };
});
...
function populateLoc()
{
    ...
    console.log('cust_mp_amb_orgs_test ' + opts);
    mPageCCLCall('cust_mp_amb_orgs_test', parseReply)(opts);
}
...
function populateProv()
{
    ...
    console.log('cust_obgyn_providers_test ' + opts);
    mPageCCLCall('cust_obgyn_providers_test', parseReply)(opts);
}
...
function loadPatients(isBtn){
    ...
    if(!orderLogLoading){
        ...
        if(autoRefreshTgl.isChecked() || isBtn){
            ...
            if($("#select-practiceLoc").val() !== null){
                ...
                console.log("mp_get_obgyn_pats_test " + opts);
                mPageCCLCall('mp_get_obgyn_pats_test', parseReply)(opts);
            }
        }
    }
}
...
function loadHRPatients(isBtn){
    ...
    if(!HighRiskLoading){
        ...
        if(autoRefreshHRTgl.isChecked() || isBtn){
            ...
            if($("#select-practiceLocHR").val() !== null){
                ...
                console.log("cust_mp_high_risk_obgyn_test " + opts);
                mPageCCLCall('cust_mp_high_risk_obgyn_test', parseReply, null, handleErr)(opts);
            }
        }
    }
}
