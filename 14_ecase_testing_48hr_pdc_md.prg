/************************************************************************************************************
 Program Title:     14_ecase_testing_48hr_pdc_md.prg
 Create Date:       08/11/2022
 Object name:       14_ecase_testing_48hr_pdc_md
 Source file:       14_ecase_testing_48hr_pdc_md.prg
 MCGA:
 OPAS:
 Purpose:https:
...
**************************************************************************************************************
 ...
 This report is only for ***MD DEPT OF HEALTH*** and looks for DTAs:
...
IF($TYPE = 3);EMAILING OF REPORT
    ...
    SET EMAIL_SUBJECT = build2("Ecase Kick Out - 48 P-DC MD Results Report")
    ...
    build2("The Ecase Kick Out - 48 P-DC MD Results report is attached to this email.",
...
; if (size(rs->QUAL,5) > 0); AT LEAST ONE PATIENT FOUND ABOVE
 ...
 SELECT INTO VALUE(FILE_NAME)
    ...
    and (   rs->QUAL[d1.seq].fac_State    =  "MD"
         or rs->QUAL[d1.seq].State_cd     =  "MD"
        )
